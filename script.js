...
function finishTest() {
  ...
  Пол: ${userResponses.question1},
  Возраст: ${userResponses.question2},
  Лишнее: ${userResponses.question3},
  Числовой ряд: ${userResponses.question4},
  Цвет: ${userResponses.question5},
  Город: ${userResponses.question6},
  Фигура: ${userResponses.question7},
  Привычка: ${userResponses.question8},
  Геометрия: ${userResponses.question9},
  Число: ${userResponses.question10}`;
